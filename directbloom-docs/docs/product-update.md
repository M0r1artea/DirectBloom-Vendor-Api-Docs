...
| `product_options` | Array[Obj]*| No | Defines the options (e.g., Size, Color) used by variants. **Required if variants are included in the request.** |
| `variants` | Array[Obj]*| No | Variant-specific data including SKUs and pricing.                                                           |
